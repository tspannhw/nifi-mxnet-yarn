...
try:
     ...
     print (json_string)
     hdfs.hdfs(host="princeton0.field.hortonworks.com", port=50090, user="root")
     hdfs.dump(json_string + "\n", "/mxnetyarn/" + uniqueid, mode="at")

     fh = open("/opt/demo/logs/mxnetyarn.log", "a")
     fh.writelines('{0}\n'.format(json_string))
     fh.close
